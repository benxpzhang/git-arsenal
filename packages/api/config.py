...
# File: config.cpython-311.pyc (Python 3.11)
...
DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql+asyncpg://arsenal:arsenal@localhost:5432/git_arsenal')
EMBED_API_KEY = os.getenv('EMBED_API_KEY', os.getenv('OPENAI_API_KEY', ''))
EMBED_BASE_URL = os.getenv('EMBED_BASE_URL', os.getenv('OPENAI_BASE_URL', 'https://dashscope.aliyuncs.com/compatible-mode/v1'))
